...
# Model options
AZURE_MODEL_OPTIONS = ['gpt-35-turbo', 'gpt-4', 'gpt-4-32k']  # Azure deployment names
OPENAI_MODEL_OPTIONS = ['gpt-3.5-turbo', 'gpt-4o', 'gpt-4-turbo']  # Standard OpenAI model names

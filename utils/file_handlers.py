...
@st.cache_data
def load_file_content(uploaded_file, is_template: bool = False) -> str:
    """
...
def extract_pdf_content(uploaded_file, is_template: bool) -> str:
    """
...
def extract_docx_content(uploaded_file, is_template: bool) -> str:
    """
...
def create_download_button(docx_bytes, title, workflow_option):
    """
